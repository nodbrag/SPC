        ...
        <el-header class="menu-header">
          <el-button-group>
            <el-button type="primary"
                       ...
                       v-if="currentUser.permission.sys_menu_btn_add">新增</el-button>
            <el-button type="primary"
                       icon="el-icon-edit"
                       size="small"
                       @click.native="handleEdit"
                       v-if="currentUser.permission.sys_menu_btn_edit">编辑</el-button>
            <el-button type="primary"
                       icon="el-icon-delete"
                       size="small"
                       @click.native="handleDel"
                       v-if="currentUser.permission.sys_menu_btn_del">删除</el-button>
          </el-button-group>
        </el-header>
      </el-container>
      <el-container>
...
<script>
  ...
  export default {
    ...
    computed: {
      ...mapGetters('CommonDictionaryStore',["menuAll"])
