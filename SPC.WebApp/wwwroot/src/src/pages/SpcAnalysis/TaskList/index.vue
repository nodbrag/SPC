  ...
  <el-row class="warp">
    <el-col :span="24" class="warp-main box_table" v-loading="loading" element-loading-text="拼命加载中">
      ...
      <div class="table_tool">
        <div class="box_search">
          <el-form ref="form" :model="filter">
            ...
            <!-- <el-button type="primary" icon="el-icon-circle-plus-outline" style="float: right"  size="mini" @click="showAddDialog" >时段查询</el-button> -->
          </el-form>
        </div>
      </div>
      <!--列表-->
      <el-table class="tableCss" :data="datalist" highlight-current-row @selection-change="selectInfos" stripe
        ...
        <el-table-column prop="workProcessName" label="工序名称">
        </el-table-column>
        <el-table-column prop="equipmentName" label="设备名称">
        </el-table-column>
        <el-table-column prop="quantity" label="总量">
        </el-table-column>
