           ...
           <TableToolBar :formData="formSearch"  @addModal="addModal(1)">
               <el-form-item slot="input">
                   <el-input
                             size="mini"
                             placeholder="类型搜索"
                             v-model="formSearch.equipmentType">
                   </el-input>
               </el-form-item>
  ...
  <el-row class="warp">
    <el-col :span="24" class="warp-main box_table" v-loading="loading" element-loading-text="拼命加载中">
      ...
      <div class="table_tool">
        <div class="box_search">
          <el-form ref="form" :model="filter">
            <el-input v-model="filter.equipmentClassKeyword" placeholder="设备分类名或编号" @keyup.enter.native="search" size="mini"></el-input>
      ...
      <el-table class="tableCss" :data="datalist" highlight-current-row @selection-change="selectInfos" stripe
        ...
        <el-table-column prop="equipmentClassCode" label="设备分类编号" width="280" sortable>
        </el-table-column>
        <el-table-column prop="equipmentClassName" label="设备分类名称"  sortable>
        </el-table-column>
        ...
        <el-table-column label="操作" width="180">
          <template slot-scope="scope">
            ...
            <el-button type="danger" @click="del(scope.row.equipmentClassID)" size="small">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
      <!--工具条-->
      ...
      <el-dialog  :visible.sync ="addFormVisible"  :before-close="closeAddDialog">
        <div slot="title">添加设备分类</div>
        <el-form :model="addForm" label-width="130px" :rules="editFormRules" ref="addForm">
          <el-form-item label="设备分类编号:" prop="equipmentClassCode">
            <el-input v-model="addForm.equipmentClassCode" auto-complete="off"></el-input>
          </el-form-item>
          <el-form-item label="设备分类名称:" prop="equipmentClassName">
            <el-input v-model="addForm.equipmentClassName" auto-complete="off"></el-input>
          </el-form-item>
      ...
      <el-dialog  :visible.sync ="editFormVisible"   :before-close="closeEditDialog">
        <div slot="title">编辑设备分类</div>
        <el-form :model="editForm" label-width="130px" :rules="editFormRules" ref="editForm">
          <el-form-item label="设备分类编号:" prop="equipmentClassCode">
            <el-input v-model="editForm.equipmentClassCode" auto-complete="off"></el-input>
          </el-form-item>
          <el-form-item label="设备分类名称:" prop="equipmentClassName">
            <el-input v-model="editForm.equipmentClassName" auto-complete="off"></el-input>
          </el-form-item>
          <el-form-item label="备注:" prop="memo">
...
<script>
  import EquipmentClassView from '../../../View/EquipmentClassView';
  export default new EquipmentClassView()
</script>
